...
# Read DEMO_L.xpt
demographics_df = pd.read_sas(r"C:\Users\srima\PycharmProjects\statistics_final_project\DEMO_L.xpt")
demo_df_psql = tabulate(demographics_df.head(15), headers='keys', tablefmt='psql')
print("\nFirst 15 obs of DEMO_L.xpt (demographics table)")
print(demo_df_psql)

# Read BMX_L.xpt
body_mass_df = pd.read_sas(r"C:\Users\srima\PycharmProjects\statistics_final_project\BMX_L.xpt")
...
# Read GHB_L.xpt data
ghb_df = pd.read_sas(r"C:\Users\srima\PycharmProjects\statistics_final_project\GHB_L.xpt", format='xport') 
ghb_psql = tabulate(ghb_df.head(15), headers='keys', tablefmt='psql') 
print("\nFirst 15 obs of GHB_L.xpt (glycohemoglobin table)")
print(ghb_psql)

# Read GLU_L.xpt
glucose_df = pd.read_sas(r"C:\Users\srima\PycharmProjects\statistics_final_project\GLU_L.xpt")
glucose_psql = tabulate(glucose_df.head(15), headers='keys', tablefmt='psql')
print("\nFirst 15 obs of GLU_L.xpt (glucose table)")
print(glucose_psql)

# Read BPXO_L.xpt
bp_df = pd.read_sas(r"C:\Users\srima\PycharmProjects\statistics_final_project\BPXO_L.xpt")
bp_psql = tabulate(bp_df.head(15), headers='keys', tablefmt='psql')
print("\nFirst 15 obs of BPXO_L.xpt (BP table)")
print(bp_psql)

# Read INS_L.xpt data
insulin_df = pd.read_sas(r"C:\Users\srima\PycharmProjects\statistics_final_project\INS_L.xpt", format='xport')
...
inflammation_df = pd.read_sas(r"C:\Users\srima\PycharmProjects\statistics_final_project\HSCRP_L.xpt", format='xport')
...
total_chol_df = pd.read_sas(r"C:\Users\srima\PycharmProjects\statistics_final_project\TCHOL_L.xpt", format='xport')
...
# Read HDL_L.xpt data
hdl_df = pd.read_sas(r"C:\Users\srima\PycharmProjects\statistics_final_project\HDL_L.xpt", format='xport')
